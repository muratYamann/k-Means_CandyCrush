 ...
 */
public class Adim1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /**Timer*/
        final CounterClas timer =new CounterClas(900000,1000);
        timer.start();

        Uri path= Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.game);
        mp = MediaPlayer.create(Adim1.this, path);
        mp.start();


        Uri pathb= Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.btn);
        mb =MediaPlayer.create(Adim1.this,pathb);
